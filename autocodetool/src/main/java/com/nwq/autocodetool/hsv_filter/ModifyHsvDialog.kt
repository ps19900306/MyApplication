...
import com.nwq.autocodetool.databinding.DialogModifyHsvRuleBinding
...
class ModifyHsvDialog(
    ...
    BaseDialogFragment<DialogModifyHsvRuleBinding>() {
    ...
    override fun createBinding(
        ...
        container: ViewGroup?
    ): DialogModifyHsvRuleBinding {
        return DialogModifyHsvRuleBinding.inflate(inflater)
    }
